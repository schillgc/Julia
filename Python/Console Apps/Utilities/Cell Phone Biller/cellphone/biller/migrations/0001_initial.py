# Generated by Django 6.0a1 on 2025-10-18 06:51
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phone",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="biller.phone"
                    ),
                ),
                (
                    "user",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="biller.user"
                    ),
                ),
            ],
            options={
