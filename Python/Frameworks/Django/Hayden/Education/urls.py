...
urlpatterns = [
    ...
    path('credit/create/', CreditCreateView.as_view(), name='credit-create'),
    path('credit/<slug>/delete/', CreditDeleteView.as_view(), name='credit-delete'),
    path('class/<slug>/', CreditDetailView.as_view(), name='credit-detail'),
    path('classes', CreditIndexView.as_view(), name='classes'),
    path('credit/<slug>/update/', CreditUpdateView.as_view(), name='credit-update'),
