    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, max_length=254, verbose_name="Instructor's Email Address")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('track', models.CharField(blank=True, choices=[('TRADITIONAL', 'Traditional'), ('ACADEMIC', 'Academic'), ('HONORS', 'Honors'), ('ADVANCED', 'Advanced'), ('ADVANCED_PLACEMENT', 'AP')], max_length=18, verbose_name='Course Track')),
                ('clep_exam', models.BooleanField(default=False, verbose_name='College-Level Examination Program®')),
                ('registered', models.BooleanField(default=False)),
                ('letter_grade', models.CharField(blank=True, choices=[('A_PLUS', 'A+'), ('A', 'A'), ('A_MINUS', 'A-'), ('B_PLUS', 'B+'), ('B', 'B'), ('B_MINUS', 'B-'), ('C_PLUS', 'C+'), ('C', 'C'), ('C_MINUS', 'C-'), ('D_PLUS', 'D+'), ('D', 'D'), ('D_MINUS', 'D-'), ('F', 'F')], max_length=7, verbose_name='Letter Grade')),
                ('term', models.CharField(blank=True, choices=[('SEMESTER', 'Semester'), ('SUMMER', 'Summer'), ('YEAR', 'Full Year')], max_length=9, verbose_name='Class Weight')),
                ...
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Education.instructor', verbose_name='Teacher')),
            ],
            options={
