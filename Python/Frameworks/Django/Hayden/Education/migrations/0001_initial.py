    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(choices=[('Academic Advisor', 'Advisor'), ('Counselor', 'Counselor'), ('Mentor', 'Mentor'), ('School Nurse', 'Nurse'), ('Club Faculty Sponsor', 'Sponsor'), ('Class Instructor', 'Teacher')], max_length=20, verbose_name='Professional Role Title')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_fee', djmoney.models.fields.MoneyField(decimal_places=0, default_currency='USD', max_digits=3)),
                ...
                ('student_activity_fee', djmoney.models.fields.MoneyField(decimal_places=0, default_currency='USD', max_digits=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher', models.ManyToManyField(blank=True, to='Education.instructor', verbose_name='Course Teacher')),
            ],
            options={
