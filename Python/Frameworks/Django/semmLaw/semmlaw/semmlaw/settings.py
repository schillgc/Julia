"""
Django settings for semmlaw project.
...
SECRET_KEY = 'django-insecure-k5aa(6plx05743#x7y*wt$y$k0r7g*ey51+)=03aud2i96@mpr'
...
WSGI_APPLICATION = 'semmlaw.wsgi.application'
